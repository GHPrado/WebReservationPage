...
<br>
<h3>Reservas del periodo: <%=request.getParameter("mesBuscar")%></h3>
<br>
<table>
    <thead>
    <tr>
...
<tbody>
    <% Controladora control = new Controladora();
        ...
        for (int i = 0; i < listReserva.size(); i++) {
            ...
            String mesBuscar = request.getParameter("mesBuscar");
            
            if (logic.Verificar_reservaMes(mesBuscar, listReserva.get(i).getFechaDesde(),listReserva.get(i).getFechaHasta())) {
